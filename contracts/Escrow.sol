...
contract Escrow {
    ...
    function list(
        ...
        purchasedPrice[_nftID] = _purchasePrice;
    ...
    // Finalize Sale
    // Require inspection status (add more items here, like appraisal, etc)
    ...
    // -> if inspection status is not approved, then refund, othersise send to seller
